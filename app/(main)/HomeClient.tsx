  ...
  return (
    <>
      ...
      <div className="dark-home-bg">
        ...
        >
          {bannerData.map((slide, index) => (
            ...
            >
              <img
                src={slide.img}
                alt={`Aro Ekdin Volleyball Team - ${slide.title}`}
        ...
        {/* Semantic intro text for SEO crawlers */}
        <section className="sr-only">
          <h2>Welcome to Aro Ekdin Volleyball Team</h2>
          <p>
            Aro Ekdin is a competitive volleyball team based in Bangladesh bringing together passionate athletes, sportsmanship, regular tournament matches, and community training.
          </p>
        </section>
