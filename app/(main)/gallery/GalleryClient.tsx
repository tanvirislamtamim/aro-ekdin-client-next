  ...
  return (
    <div className="min-h-screen bg-black text-white py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h1 className="text-5xl sm:text-7xl md:text-8xl font-black tracking-tight overflow-visible whitespace-normal wrap-break-word inline-block max-w-full px-2">
          ...
          <p className="text-gray-400 mt-4 text-lg">
            Capturing moments, creating memories — Aro Ekdin Volleyball Team
          </p>
        </motion.div>
              ...
              >
                <div className="relative overflow-hidden rounded-2xl border border-white/20 bg-linear-to-br from-white/10 to-white/5 backdrop-blur-sm shadow-2xl transition-all duration-300">
                  ...
                  <div className="relative overflow-hidden">
                    <img
                      src={image.url}
                      alt={`Aro Ekdin Volleyball Team - ${image.title || "Photo"}`}
