...
export const DEFAULT_LINEUP_PLAYERS: CourtPlayer[] = [
  ...
  },
  {
    ...
    name: "Rakibul Hasan",
    role: "Middle Blocker",
    detailedPosition: "Iron Wall & Quick Setter Counter",
    img: "https://res.cloudinary.com/do8awe7fc/image/upload/q_auto/f_auto/v1777145445/Sajjad_egabvp.png",
    stats: { spikes: 85, blocks: 97, aces: 82, digs: 80 },
    bio: "Dominant middle presence capable of reading setter hand motions in split seconds and executing impenetrable roof blocks.",
  ...
  },
  {
    ...
    name: "Al Amin",
    role: "Libero",
    detailedPosition: "Defensive Anchor & Reception Specialist",
    img: "https://res.cloudinary.com/do8awe7fc/image/upload/q_auto/f_auto/v1777145446/Shehad_tvxges.jpg",
    stats: { spikes: 40, blocks: 55, aces: 70, digs: 99 },
    bio: "Fearless floor defender known for unbelievable reflex saves, pancake recoveries, and perfect first passes off rival spikes.",
